...
export class News extends Component {
  ...
  static propTypes={
   ...
   async updateNews(){
        const url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=fcae3d36684547ec90820ea09d27b60a&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    ...
    return (
      <div className="container my-3">
       ...
       {/* </InfiniteScroll> */}
        ...
        <NewsItems title="myTitle" discription="mydesc"/>
        </div>
        <div className="col-md-4">
        <NewsItems title="myTitle" discription="mydesc"/>
        </div> */}
